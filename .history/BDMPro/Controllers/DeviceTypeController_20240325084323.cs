    ...
    public class DeviceTypeController : Controller
    {
        ...
        public async Task<IActionResult> GetPartialViewDeviceType([FromBody] dynamic requestData)
        {
            try
            {
                ...
                PaginatedList<DeviceViewModel> result = await PaginatedList<DeviceViewModel>.CreateAsync(list, pg ?? 1, size.Value, total.Value, headers, searchMessage);
        ...
        public IQueryable<DeviceViewModel> ReadDeviceTypes()
        {
        ...
        public DeviceViewModel GetViewModel(string Id, string type)
        {
        ...
        public void ValidateModel(DeviceViewModel model)
        {
            if (model != null)
            {
        ...
        public void SaveRecord(DeviceViewModel model)
        {
            if (model != null)
            {
