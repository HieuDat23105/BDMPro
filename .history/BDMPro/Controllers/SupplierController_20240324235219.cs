...
namespace BDMPro.Controllers
{
    ...
    public class SupplierController : Controller
    {
        ...
        public SupplierController(DefaultDBContext _db, UserManager<> userManager,
                              SignInManager<> signInManager, Util _util, ErrorLoggingService logger, IConfiguration configuration, IWebHostEnvironment _environment)
        {
            db = _db;
