    ...
    if (model != null)
    {
        ...
        public IActionResult Delete(string Id)
        {
            try
            {
                if (Id != null)
                {
                    DeviceType deviceType = db.GlobalOptionSets.Where(a => a.Id == Id).FirstOrDefault();
                    if (deviceType != null)
                    {
                        db.GlobalOptionSets.Remove(deviceType);
                        db.SaveChanges();
                    }
                }
            ...
            {
                GlobalOptionSet deviceType = db.GlobalOptionSets.Where(a => a.Id == Id).FirstOrDefault();
                if (deviceType == null)
                {
                    TempData["NotifySuccess"] = Resource.RecordDeletedSuccessfully;
                }
