    ...
    if (model != null)
    {
        ...
        public IActionResult Delete(string Id)
        {
            try
            {
                if (Id != null)
                {
                    DeviceType deviceType = db.DeviceTypes.Where(a => a.DeviceTypeIdId == Id).FirstOrDefault();
                    if (deviceType != null)
                    {
            ...
            {
                GlobalOptionSet deviceType = db.DeviceTypes.Where(a => a.Id == Id).FirstOrDefault();
                if (deviceType == null)
                {
                    TempData["NotifySuccess"] = Resource.RecordDeletedSuccessfully;
                }
