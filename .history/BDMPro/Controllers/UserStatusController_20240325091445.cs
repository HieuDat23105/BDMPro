...
namespace BDMPro.Controllers
{
    ...
    public class UserStatusController : Controller
    {
        ...
        [HttpPost]
        public async Task<IActionResult> GetPartialViewUserStatus([FromBody] dynamic requestData)
        {
            try
            {
        ...
        public GlobalOptionSetViewModel GetViewModel(string Id, string type)
        {
            ...
            try
            {
                ...
                if (type == "View")
                {
                    model.CreatedA ndModified = util.GetCreatedAndModified(globalOptionSet.CreatedBy, globalOptionSet.IsoUtcCreatedOn, globalOptionSet.ModifiedBy, globalOptionSet.IsoUtcModifiedOn);
                }
            }
            catch (Exception ex)
            {
