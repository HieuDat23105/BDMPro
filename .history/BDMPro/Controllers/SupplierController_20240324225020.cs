...
namespace BDMPro.Controllers
{
    ...
    public class SupplierController : Controller
    {
        ...
        public void SetupSupplierSelectLists(SupplierViewModel model)
        {
            ...
            model.ContactSelectList = util.GetDataForDropDownList(model.ContactId, db.GlobalOptionSets, a => a.DisplayName, a => a.Id, a => a.Type == "SupplierStatus", a => a.OptionOrder, "asc");
        }
