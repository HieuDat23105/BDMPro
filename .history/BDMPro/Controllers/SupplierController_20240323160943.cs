...
namespace BDMPro.Controllers
{
    ...
    public class SupplierController : Controller
    {
        ...
        {
            model.SupplierStatusSelectList = util.GetDataForDropDownList(model.SuppieStatusId, db.GlobalOptionSets, a => a.DisplayName, a => a.Id, a => a.Type == "UserStatus", a => a.OptionOrder, "asc");
        }
