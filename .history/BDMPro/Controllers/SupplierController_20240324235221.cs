...
namespace BDMPro.Controllers
{
    ...
    {
        private readonly UserManager<Asp> _userManager;
        private readonly SignInManager<Asp> _signInManager;
        ...
        public SupplierController(DefaultDBContext _db, UserManager<Asp> userManager,
                              SignInManager<Asp> signInManager, Util _util, ErrorLoggingService logger, IConfiguration configuration, IWebHostEnvironment _environment)
        {
            db = _db;
