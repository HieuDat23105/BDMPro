...
namespace BDMPro.Controllers
{
    ...
    public class SupplierController : Controller
    {
        ...
        public void SetupSupplierSelectLists(SupplierViewModel model)
        {
            ...
            model.ContactSelectList = util.GetDataForDropDownList(model.ContactId, db.Contacts, a => a.ContactName, a => a.ContactId, a => a.Type == "SupplierStatus", a => a.OptionOrder, "asc");
        }
