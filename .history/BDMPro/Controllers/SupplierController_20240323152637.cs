      ...
      public IQueryable<SupplierViewModel> ReadSupplierList()
{
    var supplierList = from t1 in db.Suppliers.AsNoTracking()
                       join contact in db.Contacts on t1.ContactId equals contact.ContactId into contactGroup
                       from t2 in contactGroup.DefaultIfEmpty()
                       ...
                       select new SupplierViewModel
                       {
                           ...
                           ContactName = t2.ContactName // Lấy ContactName từ bảng Contact
                       };
