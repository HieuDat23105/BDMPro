    ...
    public class DeviceTypeController : Controller
    {
        ...
        public async Task<IActionResult> GetPartialViewDeviceType([FromBody] dynamic requestData)
        {
            try
            {
                ...
                PaginatedList<DViewModel> result = await PaginatedList<DViewModel>.CreateAsync(list, pg ?? 1, size.Value, total.Value, headers, searchMessage);
        ...
        public DViewModel GetViewModel(string Id, string type)
        {
            DViewModel model = new DViewModel();
            try
            {
        ...
        [HttpPost]
        public IActionResult Edit(DViewModel model)
        {
            try
            {
                ValidateModel(model);
        ...
        public void ValidateModel(DViewModel model)
        {
            if (model != null)
            {
        ...
        public void SaveRecord(DViewModel model)
        {
            if (model != null)
            {
