            ...
            try
            {
                var supplierList = from t1 in _db.Suppliers.AsNoTracking()
                                   select new SupplierViewModel
                                   {
                                       ...
                                       CreatedOn = t1.CreatedOn != null ? t1.CreatedOn.ToString() : "",
                                   };
                return supplierList;
            }
            catch (Exception ex)
...
public SupplierProfileViewModel GetSupplierProfileViewModel(string Id, string type)
        {
            SupplierProfileViewModel model = new SupplierProfileViewModel();
            try
            {
                model = (from t1 in db.Suppliers
                         where t1.SupplierId == Id
                         select new SupplierProfileViewModel
                         {
                             SupplierId = t1.SupplierId,
                             SupplierName = t1.SupplierName,
                             Email = t1.Email,
        ...
        public IActionResult Edit(string Id)
        {
            ...
            if (Id != null)
            {
                model = GetSupplierProfileViewModel(Id, "Edit");
            }
            return View(model);
        }
        ...
        public IActionResult ViewRecord(string Id)
        {
            ...
            if (Id != null)
            {
                model = GetSupplierProfileViewModel(Id, "View");
            }
            return View(model);
        }

        [HttpPost]
        public async Task<IActionResult> Edit(SupplierProfileViewModel model)
        {
            try
            {
        ...
        public void ValidateSupplierModel(SupplierProfileViewModel model)
        {
            if (model != null)
            {
        ...
        public void AssignSupplierValues(Supplier supplier, SupplierProfileViewModel model)
        {
        ...
        public async Task<bool> SaveSupplierRecord(SupplierProfileViewModel model)
        {
            bool result = true;
            if (model != null)
            {
