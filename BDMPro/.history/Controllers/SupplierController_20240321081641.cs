        ...
        public async Task<IActionResult> GetPartialViewSupplier([FromBody] dynamic requestData)
{
    try
    {
        ...
        list = SupplierListConfig.PerformSort(list, sort); // Apply sorting here

        List<ColumnHeader> headers = ListUtil.GetColumnHeaders(SupplierListConfig.DefaultColumnHeaders, sort);
