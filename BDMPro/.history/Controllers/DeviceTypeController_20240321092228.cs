    ...
    public class DeviceTypeController : Controller
    {
        ...
        public DeviceTypeViewModel GetViewModel(string DeviceTypeId, string type)
        {
            ...
            try
            {
                ...
                model.Code = deviceType.Code;
                model.DisplayName = deviceType.DisplayName;
        ...
        public void ValidateModel(DeviceTypeViewModel model)
        {
            if (model != null)
            {
                ...
                {
                    duplicated = db.DeviceTypes.Where(a => a.DisplayName == model.DisplayName && a.Type == "DeviceType" && a.DeviceTypeId != model.DeviceTypeId).Any();
                }
                else
                {
                    duplicated = db.DeviceTypes.Where(a => a.DisplayName == model.DisplayName && a.Type == "DeviceType").Select(a => a.DeviceTypeId).Any();
                }
