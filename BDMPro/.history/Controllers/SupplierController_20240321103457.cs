...
namespace BDMPro.Controllers
{
    ...
    public class SupplierController : Controller
    {
        ...
        {
            model.SupplierSelectList = _util.GetDataForDropDownList(model.SupplierId, _db.GlobalOptionSets, a => a.DisplayName, a => a.Id, a => a.Type == "SupplierStatus", a => a.OptionOrder, "asc");
