    ...
    public class DeviceTypeController : Controller
    {
        ...
        public void ValidateModel(DeviceTypeViewModel model)
        {
            if (model != null)
            {
                ...
                {
                    duplicated = db.DeviceTypes.Where(a => a.TypeName == model.TypeName && a.Type == "DeviceType" && a.DeviceTypeId != model.DeviceTypeId).Any();
                }
                else
                {
                    duplicated = db.DeviceTypes.Where(a => a.TypeName == model.TypeName && a.Type == "DeviceType").Select(a => a.DeviceTypeId).Any();
                }
