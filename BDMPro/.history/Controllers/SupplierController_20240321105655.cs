...
namespace BDMPro.Controllers
{
    ...
    public class SupplierController : Controller
    {
        ...
        public void AssignSupplierValues(Supplier supplier, SupplierViewModel model)
        {
            ...
            supplier.SupplierStatusId = string.IsNullOrEmpty(model.SupplierStatusId) ? util.GetGlobalOptionSetId(UserStatus.Registered.ToString(), "UserStatus") : model.SupplierStatusId;
