                        ...
                        if (errors.Count == 0)
                        {
                            for (int i = 0; i < dtRowsCount; i++)
                            {
                                try
                                {
                                    ...
                                    Supplier.SuppId = Guid.NewGuid().ToString();
                                    Supplier.QuestionTitle = questionTitle;
                                    Supplier.SubjectId = subjectId;
                                    Supplier.QuestionTypeId = questionTypeId;
                                    Supplier.IsActive = status == "Active" ? true : false;
