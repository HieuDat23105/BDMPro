    ...
    public class SupplierController : Controller
    {
        ...
        public async Task<IActionResult> GetPartialViewSupplier([FromBody] dynamic requestData)
        {
            try
            {
                ...
                PaginatedList<SupplierViewModel> result = await PaginatedList<SupplierViewModel> result = await PaginatedList<SupplierViewModel>.CreateAsync(list.AsQueryable(), pg ?? 1, size.Value, total.Value, headers, searchMessage);
