...
namespace BDMPro.Controllers
{
    ...
    public class DeviceTypeController : Controller
    {
        ...
        [HttpPost]
        public async Task<IActionResult> GetPartialVie([FromBody] dynamic requestData)
        {
            try
            {
        ...
        public IQueryable<GlobalOptionSetViewModel> Reaes()
        {
        ...
        public void ValidateModel(GlobalOptionSetViewModel model)
        {
            if (model != null)
            {
                ...
                if (duplicated == true)
                {
                    ModelState.AddModelError("DisplayName", ResourceNameAlreadyExist);
                }
            }
        }
