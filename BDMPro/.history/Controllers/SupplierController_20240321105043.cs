...
namespace BDMPro.Controllers
{
    ...
    public class SupplierController : Controller
    {
        ...
        {
            model.SupplierSelectList = _util.GetDataForDropDownList(model.SupplierStatus, _db.GlobalOptionSets, a => a.DisplayName, a => a.Id, a => a.Type == "SupplierStatus", a => a.OptionOrder, "asc");
        }
        ...
        public async Task<IActionResult> Edit(SupplierViewModel model)
        {
            ...
            return RedirectToAction("index", "SupplierController");
        }
