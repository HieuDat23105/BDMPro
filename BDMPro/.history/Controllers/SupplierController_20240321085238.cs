...
namespace BDMPro.Controllers
{
    ...
    public class SupplierController : Controller
    {
        ...
        private readonly IWebHost_environment __environment;

        public SupplierController(DefaultDBContext db, UserManager<AspNetUsers> userManager,
                                  SignInManager<AspNetUsers> signInManager, Util util, ErrorLoggingService logger, IConfiguration configuration, IWebHost_environment _environment)
        {
            _db = db;
...
public SupplierViewModel GetSupplierViewModel(string Id, string type)
        ...
        {
            var path = Path.Combine(this.__environment.WebRootPath, "Assets", "SupplierExcelTemplate.xlsx");
