...
namespace BDMPro.Controllers
{
    ...
    public class SupplierController : Controller
    {
        ...
        public void AssignSupplierValues(Supplier supplier, SupplierViewModel model)
        {
            ...
            supplier.SupplierStatusId = string.IsNullOrEmpty(model.SupplierStatusId) ? _util.GetGlobalOptionSetId(SupplierStatus.Ac.ToString(), "SupplierStatus") : model.SupplierStatusId;
