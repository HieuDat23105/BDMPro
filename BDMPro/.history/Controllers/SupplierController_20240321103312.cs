...
namespace BDMPro.Controllers
{
    ...
    public class SupplierController : Controller
    {
        ...
        {
            model.SupplierSelectList = _util.GetDataForDropDownList(model.UserStatusId, db.GlobalOptionSets, a => a.DisplayName, a => a.Id, a => a.Type == "UserStatus", a => a.OptionOrder, "asc");
