...
public static IQueryable<SupplierView> PerformSort(IQueryable<SupplierView> list, string sort)
{
    var result = ListUtil.PerformSort<SupplierView>(list, DefaultSortOrder, sort);
    return result;
}
    }
