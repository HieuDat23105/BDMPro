...
namespace BDMPro.Utils
{
    ...
    public class SupplierListConfig
    {
        ...
        public static IQueryable<SupplierViewModel> PerformSort(IQueryable<SupplierV> list, string sort)
        {
            var result = ListUtil.PerformSort<Supplier>(list, DefaultSortOrder, sort);
            return result;
        }
    }
