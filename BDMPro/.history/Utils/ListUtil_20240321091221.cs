...
namespace BDMPro.Utils
{
    ...
    public class DeviceTypeListConfig
    {
        public static readonly List<string> TableColumns = new List<string>() {
                nameof(DeviceViewModel.OptionOrder),
                nameof(DeviceViewModel.DisplayName),
                nameof(DeviceViewModel.Actions)
            };

        //searchMessage = the placeholder for the search bar, from here, you can set different placeholder for different listconfig
        public static string SearchMessage = $"{Resource.Search}...";
        public static IQueryable<DeviceViewModel> PerformSearch(IQueryable<DeviceViewModel> list, string search)
        {
            if (!string.IsNullOrEmpty(search))
            {
                //perform search
        ...
        public static string DefaultSortOrder = $"{nameof(DeviceViewModel.OptionOrder)}-asc";
        public static int? DefaultPageSize = 10;
        public static List<SelectListItem> PageSizeDropDownList = ListUtil.GetPageSizeDropDownList(DefaultPageSize);
        public static readonly ColumnHeader[] DefaultColumnHeaders = ListUtil.GenerateDefaultColumnHeaders<DeviceViewModel>(DefaultSortOrder, TableColumns);

        public static IQueryable<DeviceViewModel> PerformSort(IQueryable<DeviceViewModel> list, string sort)
        {
            var result = ListUtil.PerformSort<DeviceViewModel>(list, DefaultSortOrder, sort);
            return result;
        }
    }
